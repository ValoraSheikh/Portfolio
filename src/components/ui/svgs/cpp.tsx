...
const Cpp = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <g>
      ...
      {/* Plus Signs */}
      <polygon
        points="91,59.42 86.95,59.42 86.95,55.37 82.91,55.37 82.91,59.42 78.86,59.42 78.86,63.46 82.91,63.46 82.91,67.51 86.95,67.51 86.95,63.46 91,63.46"
        fill="#FFFFFF"
      />
      <polygon
        points="106.16,59.42 102.12,59.42 102.12,55.37 98.07,55.37 98.07,59.42 94.03,59.42 94.03,63.46 98.07,63.46 98.07,67.51 102.12,67.51 102.12,63.46 106.16,63.46"
        fill="#FFFFFF"
      />
    </g>
  </svg>
